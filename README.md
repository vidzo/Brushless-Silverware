...
STEP 2:  Open hardware.h and make edits to set your brushless settings
		 ...
		 _Batter Voltage Settings_ - set ADC to give correct battery voltage setting for telemetry and LVC *Can be viewed in debug if using without telemetry. Values to be changed to get battery voltage explained in miscellaneous.c file and wiki
